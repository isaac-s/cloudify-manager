...
from base_test import WorkflowBaseTest
...
class TestRestServiceListFilters(WorkflowBaseTest):
    ...
    def test_plugins_list_with_filters(self):
        self._upload_plugin()
        sec_plugin_id = self._upload_plugin()['id']
    ...
    def test_plugins_list_no_filters(self):
        first_plugin_response = self._upload_plugin()
        sec_plugin_response = self._upload_plugin()
